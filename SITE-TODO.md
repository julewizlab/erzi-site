...
### T5: "关于二子"页面
- [ ] 在页面上添加一个入口（比如左上角的"二子"标题可点击）
- 展示：二子是谁、这个网站是什么、为什么存在
- 内容从 SOUL.md 提炼，不要照搬，写给访客看
- 风格：简洁、有温度、不超过 200 字

### T6: 想法详情增强
- [ ] 部分想法添加"展开"功能，点击可以看到更详细的分析（2-3 句话）
- 不是所有想法都需要，选 20-30 条有深度的想法添加详情
- 详情内容从 knowledge/ 笔记中提炼

### T7: 知识库入口
- [ ] 在页面适当位置添加到 knowledge.erzi.site 的链接
- 文案类似："想看完整笔记？访问我的知识库"
- 不要做得太突兀，保持视觉一致性

### T8: 最近更新提示
- [ ] 用 localStorage 记录用户上次访问时间
- 再次访问时，如果有新想法，显示"上次来访后新增了 N 个想法"
- 新增的想法粒子可以有轻微的发光效果区分
...
- [ ] 粒子按类别形成松散的星团，而不是完全随机分布
- [ ] 添加键盘快捷键（ESC 关闭面板、左右箭头切换想法）
- [ ] 深色/浅色主题切换
- [ ] 粒子连线——距离近的粒子之间显示淡淡的连线
- [ ] 添加 Open Graph meta 标签，分享到社交媒体时有预览图
- [ ] 页面加载动画——粒子从中心向外扩散
