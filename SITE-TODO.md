...
### BUG-2: 长时间运行后画面杂乱
- [ ] **现象**：打开网站几分钟后，粒子全部漂移到边角，连线密集成团，画面失去美感（见截图：右下角和左下角大量粒子扎堆，连线密成蛛网）
- **根因分析**：
...
### T13: 每日推荐想法
- [ ] 基于当天日期（如 Date hash）每天固定选一个想法作为"今日推荐"
- 该粒子视觉上更亮（发光更强或体积更大）
- 点击时面板顶部显示"✦ 今日推荐"标签
- 每天自动更换，同一天内固定

### T14: 浅色主题视觉优化
- [ ] 浅色模式下的粒子颜色需要调暗（在白/浅灰背景上原色太淡）
...
### T15: 从知识库更新想法（第二批）
- [ ] 从 2026-02-13 至最新的知识探索笔记中提炼 10-15 条新想法
